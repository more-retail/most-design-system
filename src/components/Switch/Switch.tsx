...
function Switch({
  ...
  const isExpanded = (isHovered || dragRef.current !== null) && !disabled;
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center rounded-full transition-all duration-150 touch-none select-none",
        ss.container,
        isExpanded ? ss.paddingHover : ss.paddingDefault,
    ...
    >
      <div
        className={cn(
          ...
          isExpanded ? ss.thumbHover : ss.thumbDefault,
        )}
      />
    </button>
  );
